...
/**
 * Created by kdegtiarenko on 1/27/2015.
 */
public class WeatherDataParser {
    ...
    public static double getMaxTemperatureForDay(String weatherJsonStr, int dayIndex) {
        ...
        try {
            ...
            JSONObject jObject2 = jArray.getJSONObject(dayIndex);
            JSONObject jObject3 = jObject2.getJSONObject("temp");
            maxTemp = (Double) jObject3.get("max");
        } catch (JSONException e) {
            Log.e("WeatherDataParser", e.getMessage());
        }
        return maxTemp;
    }
